# Generated by Django 5.1.5 on 2025-01-30 13:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_type', models.CharField(choices=[('number', 'Number'), ('text', 'Text'), ('email', 'Email'), ('date', 'Date'), ('checkbox', 'Checkbox'), ('textarea', 'Textarea'), ('file', 'File'), ('image', 'Image')], db_index=True, max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Table',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('table', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='table_api', to='rest.table')),
